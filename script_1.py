...
print(crop_coordinates_left_red, crop_coordinates_middle_red)
...
crop_coordinates_right_blue = (0, 0, round(blue_image.width * 0.9), blue_image.height)
crop_coordinates_middle_blue = (round(blue_image.width * 0.05), 0, round(blue_image.width * 0.95), blue_image.height)
...
crop_coordinates_green = (round(green_image.width * 0.05), 0, round(green_image.width * 0.95), green_image.height)
